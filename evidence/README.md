...
| `checkpoints.md` | Every checkpoint branch built and, where the document makes a behavioural claim, run through the verifier. step-3 fails in exactly the two gates CHECKPOINTS.md names. |
